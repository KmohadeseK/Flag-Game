...
function animationmovePL1(e){
  ...
  if(e.keyCode == "37"){
    ...
    PL1 =document.querySelector(".PL1").style.backgroundImage =  "url(asist/img/PL1/normalLeft.png)"
    PL1 =document.querySelector(".PL1").style.animationName ="move-left-run-PL1";
    ...
    PL1 =document.querySelector(".PL1").style.animationName ="move-right-run-PL1";
    
    PL1 =document.querySelector(".PL1").style.backgroundImage =  "url(asist/img/PL1/normalRight.png)"
  }
